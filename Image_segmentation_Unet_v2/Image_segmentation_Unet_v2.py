...
def conv_block(inputs=None, n_filters=32, dropout_prob=0, max_pooling=True):
    ...
    conv2_filters = n_filters  # Correction: using n_filters instead of n_filters * 2
    kernel_size = (3, 3)
    
    # First convolutional layer
    conv = Conv2D(conv1_filters, 
                  kernel_size,
                  activation='relu',
                  padding='same',
    ...
    # Add max-pooling layer if max_pooling is True
    if max_pooling:
...
def upsampling_block(expansive_input, contractive_input, n_filters=32):
    ...
    up = Conv2DTranspose(
                 ...
                 (3, 3),    # Kernel size
                 strides=(2, 2),  # Strides for upsampling
